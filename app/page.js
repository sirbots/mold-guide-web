    ...
    <main className={styles.container}>
      ...
      <div className={styles.homeContent}>
        ...
        <div className={styles.intro}>
          ...
          <p>
            Maybe you're plagued with anxiety and depression, chronic fatigue,
            or constant muscle and joint aches. Maybe you're coughing more or
            having trouble sleeping.
          </p>
          <p>
            Maybe you're suffering from brain fog, cognitive impairment, or
            memory loss. You're reacting to foods that never bothered you before
            or you developed eczema, psorisasis, or weird rashes.
          </p>
          <p>
